  ...
  <div class="container pt-5">
    <div class="row pt-5 reverse-row-mobile">
      <div class="col-xl-6 order-1">
        <h1 class="hero-text">
          <span class="hero-text-small">Hi, my name is</span> <br />
          <span class="hero-text-name"> Isaiah Wright </span><br />
          I build full stack applications :)
        </h1>
        <p class="descriptive-text pt-1">
          I have always been interested in computers and how they work. When I
          click a button I find myself asking: Why does something happen? What
      ...
      <div class="col-xl-6 text-center order-xl-1">
        <img
          ...
          src="../assets/img/headshotNew.jpeg"
          alt=""
        />
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-xl-1">
                <img
                  ...
                  src="../assets/img/UWRG-logo-sm.png"
                  alt=""
                />
              </div>
              <div class="col-xl-11">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-xl-1">
                <img
                  class="experience-company-logo"
                  src="../assets/img/codeworks.png"
                  alt=""
                />
              </div>
              <div class="col-xl-11">
                <p class="experience-heading">Software Development Student</p>
                <p class="experience-company">Boise Code Works</p>
                <p class="experience-heading-2nd">January 2020 - April 2020</p>
                <p class="experience-heading-2nd">
                  Boise, Idaho, United States
                </p>
                <p class="experience-responsibilities">
                  13 Week immersive course completed 500+ hours learning and
                  utilizing best practices in software development.
                </p>
                <p class="experience-responsibilities">
                  Built full stack applications utilizing modern tech stacks
                  such as JavaScript, .Net, and Vue.js
                </p>
                <p class="experience-responsibilities">
                  Used Scrum and Sprint planning in order to effectively
                  collaborate in a team.
                </p>
                <p class="experience-responsibilities">
                  Learned design patterns such as MVC to make an application
                  more secure.
                </p>
                <p class="experience-responsibilities">
    ...
    <div class="row pt-5 text-center">
      ...
      <div class="col-md-3 col-6" style="position: relative">
        <img class="skill-logo" src="../assets/img/Skills/html5.png" alt="" />
        <p class="skill-text">HTML</p>
      </div>
      <div class="col-md-3 col-6">
        <img class="skill-logo" src="../assets/img/Skills/sass.png" alt="" />
        <p class="skill-text">SCSS</p>
      </div>
    </div>
    <div class="row pt-3 text-center">
      <div class="col-md-3 col-6">
        <img class="skill-logo" src="../assets/img/Skills/nodejs.png" alt="" />
    ...
    <div class="row pt-1">
      ...
      <div class="col-md-4 pt-4 text-center">
        <div class="card">
          ...
          <p class="skill-text">Communication</p>
          <p class="skill-text">Problem Solving</p>
          <p class="skill-text">Critical Thinking</p>
        </div>
      </div>
    </div>
    <div class="row pt-5">
      <div class="col-12">
        <h2 class="section-heading">Projects I've Worked On:</h2>
      </div>
    </div>
    <div class="row pt-3">
      ...
      <div class="col-xl-6">
        ...
        <p class="descriptive-text pt-3">
          ...
          a estimate off of a scope sheet. With the help of the Water Damage
          Estimator, they can now create a much more accurate estimate in an
          average time of 5 minutes. All the technician needs to do is put in
          the measurements of the room they are working in and answer a few
          questions. This application will then automatically calculate how much
          equipment they will need and how much it will cost displaying it in a
          estimate format that can be shown to a customer.
        </p>
        <p class="descriptive-text pt-3">
          I worked solo on this project responsible for the front-end and
          back-end development of the entire application. Watching it grow to
          handle more and more has been nothing less than fantastic. I am proud
          to say I have created something that has met and surpassed the goals
          originally planned for it.
        </p>
        <p class="descriptive-text pt-3">
          I have done multiple presentations on this application all over
          Florida and trained multiple technicians how to use it. I cant wait to
          see what other challenges I will face in the future.
        </p>
        ...
        >
          ...
          <p class="skills-additional">Twillio Send Grid</p>
        </div>
      </div>
    </div>
    <div class="row pt-5">
    ...
    <div class="row">
      <div class="col-xl-6">
        <p class="descriptive-text pt-3">
          ...
          that marketer. Each time a lead is submitted it sends a link to the
          lead details is sent directly to the marketer via sms. It is then
          received and processed automatically syncing to a company google
          sheet.
        </p>
        <p class="descriptive-text pt-3">
          This is my second solo full-stack application at United Water
          Restoration Group, and I had a blast working on it! UWRG Leads was
          built with a Vite frontend and a powerful Node.js backend. Shipped
          with stunning UI using the latest SCSS practices and design trends.
          Please refer to the list below for some of the technologies used in
          UWRG Leads.
        </p>
      </div>
      <div class="col-xl-6">
        ...
        <iframe
          width="100%"
          height="400"
          src="https://www.youtube.com/embed/o5wriLsOve0"
    ...
    <div class="row pt-3">
      <div class="col-12">
        ...
        >
          ...
          <p class="skills-additional">Socket.io</p>
          <p class="skills-additional">Google Address Autocomplete</p>
          <p class="skills-additional">Google Sheets Integration</p>
        </div>
      </div>
    </div>
    <!-- Cool Buttons -->
...
.card {
  ...
  &:hover {
    box-shadow: 0 0.25rem 1rem rgba($blue, 0.4);
  }
}
